...
import 'request_password_reset_model.dart';
export 'request_password_reset_model.dart';

class RequestPasswordResetWidget extends StatefulWidget {
  const RequestPasswordResetWidget({super.key});
...
class _RequestPasswordResetWidgetState
  ...
  late RequestPasswordResetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RequestPasswordResetModel());
                      ...
                      child: FFButtonWidget(
                        onPressed: (_model.emailTextController.text == null ||
                            ...
                            : () async {
                                ...
                                if ((_model.apiResult7qy?.succeeded ?? true)) {
