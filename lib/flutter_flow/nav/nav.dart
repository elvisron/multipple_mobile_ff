...
class AppStateNotifier extends ChangeNotifier {
  ...
  MultippleAuthUser? initialUser;
  MultippleAuthUser? user;
  ...
  void update(MultippleAuthUser newUser) {
    final shouldUpdate =
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? NavBarPage() : LoginAndSignupWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          builder: (context, params) => NavBarPage(
            ...
            page: LearnvVideoWidget(
              ...
              videoSourceType: params.getParam(
                'videoSourceType',
                ParamType.String,
              ),
              poster: params.getParam(
                'poster',
                ParamType.String,
              ),
              outline: params.getParam<dynamic>(
                'outline',
                ParamType.JSON,
                isList: true,
              ),
        ...
        FFRoute(
          ...
          builder: (context, params) => RequestPasswordResetWidget(),
        ),
        FFRoute(
          name: 'accountPageUserAchievement',
          path: '/accountPageUserAchievement',
          builder: (context, params) => NavBarPage(
            initialPage: '',
            page: AccountPageUserAchievementWidget(),
          ),
        )
