...
import 'video_list_unplayed_model.dart';
...
class _VideoListUnplayedWidgetState extends State<VideoListUnplayedWidget> {
  late VideoListUnplayedModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VideoListUnplayedModel());
  }
