...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    multippleAuthUserSubject.add(
      MultippleAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<MultippleAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  MultippleAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = MultippleAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    multippleAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
